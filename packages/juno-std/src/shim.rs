...
impl Serialize for Timestamp {
        ...
        where S: Serializer
    {
        ...
        ts.normalize();
        let dt = DateTime::from_timestamp(ts.seconds, ts.nanos as u32).expect(
        ...
        where D: Deserializer<'de>
    {
        ...
        impl<'de> Visitor<'de> for TimestampVisitor {
            ...
            fn visit_str<E>(self, value: &str) -> Result<Self::Value, E> where E: de::Error {
                let utc: DateTime<Utc> = chrono::DateTime
                    ::from_str(value)
                    .map_err(|err| {
                        serde::de::Error::custom(
                            format!("Failed to parse {} as datetime: {:?}", value, err)
                        )
                    })?;
...
impl TryFrom<crate::types::cosmos::base::v1beta1::Coin> for cosmwasm_std::Coin {
    ...
    fn try_from(crate::types::cosmos::base::v1beta1::Coin {
        denom,
        amount,
    }: crate::types::cosmos::base::v1beta1::Coin) -> cosmwasm_std::StdResult<Self> {
